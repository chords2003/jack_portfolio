...
<x-panel id="job-{{ $job->id }}" class="flex gap-x-6"
    ...
    <div class="flex-1 flex flex-col">
        <a href="#" class="self-start text-m text-blue-400 transition-colors duration-300">{{ $job->employer->name }}</a>
    ...
    <div class="flex justify-between items-center mt-auto text-white">
